...
import '../AutoSize/src/auto_size_config.dart';
  ...
  static void initSize(BuildContext context) {
    ...
    if (size != Size.zero) {
      final Size autoSize = size.width > size.height
          ? Size(
              size.width / _getPixelRatio(context), AutoSizeConfig.designWidth)
          : Size(AutoSizeConfig.designWidth,
              size.height / _getPixelRatio(context));
      screenSize = autoSize;
    }
  }
