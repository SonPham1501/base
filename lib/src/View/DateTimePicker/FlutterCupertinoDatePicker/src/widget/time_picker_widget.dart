...
class _TimePickerWidgetState extends State<TimePickerWidget> {
  ...
  late bool _isChangeTimeRange = false;
    ...
    return Expanded(
      ...
      child: Container(
        ...
        child: CupertinoPicker.builder(
          ...
          childCount: format.contains('m') ? _calculateMinuteChildCount(valueRange, minuteDivider ?? 0) : valueRange.last - valueRange.first + 1,
  ...
  Widget _renderDatePickerItemComponent(int value, String format) {
    print("value $value , format $format");
    return Container(
