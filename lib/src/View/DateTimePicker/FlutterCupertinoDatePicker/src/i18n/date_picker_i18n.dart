...
class DatePickerI18n {
  ...
  static String? getLocaleDone(DateTimePickerLocale locale) {
    var i18n = datePickerI18n[locale] ?? datePickerI18n[DATETIME_PICKER_LOCALE_DEFAULT];
  ...
  static List<String>? getLocaleWeeks(DateTimePickerLocale locale, [bool isFull = true]) {
    ...
    var weeks = i18n?.getWeeksShort();
    if (weeks != null && weeks.isNotEmpty) {
      return weeks;
    }

    var fullWeeks = i18n?.getWeeksFull();
